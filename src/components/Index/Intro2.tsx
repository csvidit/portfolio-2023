...
const Intro2 = () => {
  return (
    <div
      className={`bg-gradient-to-b from-neutral-950 to-indigo-950 via-neutral-950 from-40% via-60% top-0 left-0 w-full col-span-4 rounded-b-[3rem] p-8 lg:p-12 h-max flex flex-col space-y-8 items-center text-neutral-100`}
    >
