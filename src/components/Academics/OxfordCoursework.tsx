...
const OxfordCoursework = () => {
  return (
    <div className="flex w-full lg:w-2/3 flex-col space-y-4 items-start rounded-2xl text-neutral-100 font-light">
      <SubSectionHeader>Coursework (Tutorials)</SubSectionHeader>
      <div className="w-full flex flex-col space-y-4">
        <div className="w-full flex flex-col space-y-2">
          <SubSectionTitle>International Economics (primary tutorial)</SubSectionTitle>
          <SubSectionText>
        ...
        <div className="w-full flex flex-col space-y-2">
          <SubSectionTitle>Creative Writing (secondary tutorial)</SubSectionTitle>
          <SubSectionText>
        ...
        <div className="w-full flex flex-col space-y-2">
          ...
          <SubSectionText>
           Writing seminar which consisted of analyzing three C.S. Lewis books - Mere Christianity, Till We Have Faces, and The Great Divorce. Wrote papers analyzing one or more aspects of each book, under the supervision of Dr Cosima Gillhammer, lecturer at Trinity College Oxford.
          </SubSectionText>
        </div>
      </div>
    </div>
