...
const Layers = () => {
  ...
  return (
    ...
    href="https://layers.to/vk"
      ...
      className="col-span-2 row-span-1 justify-center flex flex-col space-y-8 rounded-[3rem] p-8 lg:p-12 overflow-hidden bg-neutral-900 text-neutral-100"
    >
      <motion.div
      ...
      >
        <motion.div className="flex flex-row justify-between items-center space-x-4 w-full text-4xl lg:text-6xl">
          <motion.div className="flex geom grow">Layers.to</motion.div>
